...
\begin{bullets}
    \item Ottenuto siti web appartenenti a categorie pre-esistenti
    \item Estratto parti più importanti del testo dei siti web menzionati in precedenza e individuato per ognuno la lingua principale
    \item Rimozione di \textbf{stopwords} con la libreria NLTK in Python
    \item Applicazione di \textbf{stemming} e \textbf{lemmatization} con la libreria NLTK in Python sul dataset
    \item Creazione di \textbf{wordclouds} per visualizzare la frequenza e l'importanza di ogni parola del testo nel dataset
    \item Realizzazione di una \textbf{rete neurale} per la classificazione testuale usando le librerie Keras e TensorFlow
\end{bullets}
\sectionsep
